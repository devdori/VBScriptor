...
Function iopen(siclAddr As String) As Integer
    ...
    Exit Function
err_syst:
    MsgBox "System (iopen) Failed", vbOKOnly + vbInformation, "확인"
...
Function ivprintf(ByVal id1 As Integer, ByVal fmt As String, Optional ByVal ap As Variant) As Integer
    ...
    Exit Function
err_syst:
    MsgBox "System (ivprintf) Failed", vbOKOnly + vbInformation, "확인"
End Function
...
Function itimeout(ByVal id1 As Integer, ByVal tval As Long) As Integer
    ...
    Exit Function
err_syst:
    MsgBox "System (itimeout) Failed", vbOKOnly + vbInformation, "확인"
