...
Private Sub cmdJigConnect_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 0
            ...
            Cmd_ChangeCnt.Caption = "LMFC 반제품 핀 교체 주기"
        Case 1
            SerialOut1 (JIG2 & Chr(&HD))
            Cmd_ChangeCnt.Caption = "LMFC 완제품 핀 교체 주기"
        Case 2
            SerialOut1 (JIG3 & Chr(&HD))
            Cmd_ChangeCnt.Caption = "PSEV 반제품 핀 교체 주기"
        Case 3
            SerialOut1 (JIG4 & Chr(&HD))
            Cmd_ChangeCnt.Caption = "PSEV 완제품 핀 교체 주기"
...
''        Call MyEwpScript.ManualBTN(11)
    ...
    frmMain.StepList.Refresh ' 이 때!!!! STEP, Function, Result, Min, Value, Max, Unit 글자색이 바뀜
...
Public Sub ClearDataOnList()
    ...
    For i = 1 To MyFCT.nStepNum
        ...
        For j = 1 To 6
            ...
            Me.StepList.ListItems(i).ListSubItems(j).ForeColor = vbBlack  ' ListSubItems(j) 필요한 경우 : 글자색, 텍스트 굵게 표시, 툴팁 설정에 사용
        ...
        Me.StepList.ListItems(i).Checked = False  ' ListItems(i)의 checkbox 체크표시, ListItems(i).ListSubItems(j) 색변형
        Me.StepList.ListItems(i).SubItems(2) = ""   ' 판정
        Me.StepList.ListItems(i).SubItems(4) = ""   ' 측정값
